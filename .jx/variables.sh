...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-plugins/secretfacade/master/2'
...
export MINK_IMAGE='ghcr.io/jenkins-x/secretfacade:0.2.3'

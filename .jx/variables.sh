...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-plugins/secretfacade/master/3'
...
export MINK_IMAGE='ghcr.io/jenkins-x/secretfacade:0.0.12'
